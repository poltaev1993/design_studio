<div class="form-group">
    ...
    <div class="col-sm-9">
        {!! Form::textarea('question', null, ['class' => 'form-control editor', 'placeholder' => 'Введите вопрос', 'required']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        {!! Form::textarea('answer', null, ['class' => 'form-control editor', 'placeholder' => 'Введите ответ', 'required']) !!}
    </div>
</div>
