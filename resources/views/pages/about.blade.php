        ...
        <div class="left-sections">
            ...
            <section class="left_container text-right" id="left_section1">
                <div class="wrapper-block">
                    ...
                    <p class="text-right">
                        Добро пожаловать в раздел Интерьеры!<br>
                        Мы создаем хорошие<br>
                        интерьеры честное слово<br>
                        Добро пожаловать в раздел Интерьеры!<br>
                        Мы создаем хорошие<br>
                        интерьеры<br>
                        честно<br>
        	...
        	<div class="block-abs">
        		...
        		<div class="row what-we-take">
        			<div class="col-md-4 text-center">
        				<a class="md-trigger" data-modal="modal-12"><img src="/img/sl1.jpg" alt="" class="img-responsive">
        				<a class="md-trigger" data-modal="modal-12">задание на проектирование</a></a>
    				</div>
        			<div class="col-md-4 text-center">
        				<a href=""><img src="/img/sl1.jpg" alt="" class="img-responsive">
        				<a href="">задание на проектирование</a></a>
    				</div>
    				<div class="col-md-4 text-center">
        				<a href=""><img src="/img/sl1.jpg" alt="" class="img-responsive">
        				<a href="">задание на проектирование</a></a>
